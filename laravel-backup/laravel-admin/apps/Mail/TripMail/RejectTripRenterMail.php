...
/**
 * Class RejectTripRenterMail
 * @package App\Mail\TripMail
 */
class RejectTripRenterMail extends Mailable
{
	...
	/**
	 * RejectTripRenterMail constructor.
	 *
	 * @param Trip $trip
	 */
    ...
    {
        return $this->subject('تم رفض الحجز')->view('emails.trip.RejectTripRenterMail');
    }
}
