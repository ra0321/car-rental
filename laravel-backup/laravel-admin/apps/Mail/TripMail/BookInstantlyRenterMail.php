...
/**
 * Class BookInstantlyRenterMail
 * @package App\Mail\TripMail
 */
class BookInstantlyRenterMail extends Mailable
{
    ...
    /**
     * BookInstantlyRenterMail constructor.
     * @param Trip $trip
     * @param $renter
     */
    ...
    {
        return $this->subject('الحجز مؤكد')->view('emails.trip.BookedInstantlyTripRenterMail');
    }
}
