...
/**
 * Class AcceptTripRenterMail
 * @package App\Mail\TripMail
 */
class AcceptTripRenterMail extends Mailable
{
	...
	/**
	 * AcceptTripRenterMail constructor.
	 *
	 * @param Trip $trip
	 */
    ...
    {
        return $this->subject('تم تأكيد الحجز')->view('emails.trip.ConfirmTripRequestRenterMail');
    }
}
