...
/**
 * Class BookedInstantlyAdminMail
 * @package App\Mail\Admin
 */
class BookedInstantlyAdminMail extends Mailable
{
    use Queueable, SerializesModels, ArabicNumbers;

    public $trip;
    public $trip_bill_one;
    public $trip_bill_two;
    public $owner;
    public $renter;
    public $car;
    public $chatMessage;
    ...
    /**
     * BookedInstantlyAdminMail constructor.
     * @param Trip $trip
     */
    ...
    {
        return $this->subject('الحجز مؤكد')->view('emails.admin.BookedInstantlyAdminMail');
    }
}
