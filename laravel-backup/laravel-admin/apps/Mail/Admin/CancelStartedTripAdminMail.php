...
/**
 * Class CancelStartedTripAdminMail
 * @package App\Mail\Admin
 */
class CancelStartedTripAdminMail extends Mailable
{
    ...
    /**
     * CancelStartedTripAdminMail constructor.
     * @param Trip $trip
     */
    ...
    {
        return $this->subject('تم إلغاء الحجز')->view('emails.admin.CancelStartedTripAdminMail');
    }
}
