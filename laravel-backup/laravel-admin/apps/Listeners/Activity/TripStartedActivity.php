...
use App\Events\Activity\TripStartedEvent;

class TripStartedActivity
{
    /**
     ...
     * Handle the event.
     *
     * @param  TripStartedEvent  $event
     * @return void
     */
    public function handle(TripStartedEvent $event)
    {
        ...
        $tripNotificationOwner['activity_notification_type'] = 220;
        ...
        $tripNotificationRenter['activity_notification_type'] = 1220;
