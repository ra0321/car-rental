...
/**
 * Class AcceptTripOwnerMail
 * @package App\Mail\TripMail
 */
class AcceptTripOwnerMail extends Mailable
{
	...
	/**
	 * AcceptTripOwnerMail constructor.
	 *
	 * @param Trip $trip
	 */
    ...
    {
        return $this->subject('حجز مؤكد')->view('emails.trip.ConfirmTripRequestOwnerMail');
    }
}
