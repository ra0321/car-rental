 ...
 */
class CancelStartedTripRenterMail extends Mailable
{
	...
	/**
	 * CancelStartedTripRenterMail constructor.
	 *
	 * @param Trip $trip
	 */
    ...
    {
        return $this->subject('حجز ملغي')->view('emails.trip.CancelStartedTripRenterMail');
    }
}
