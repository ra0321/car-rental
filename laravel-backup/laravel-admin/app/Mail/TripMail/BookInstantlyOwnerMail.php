...
/**
 * Class BookInstantlyOwnerMail
 * @package App\Mail\TripMail
 */
class BookInstantlyOwnerMail extends Mailable
{
    use ArabicNumbers;
    ...
    /**
     * BookInstantlyOwnerMail constructor.
     * @param Trip $trip
     */
    ...
    {
        return $this->subject('الحجز مؤكد')->view('emails.trip.BookedInstantlyTripOwnerMail');
    }
}
